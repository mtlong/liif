...
CONFIG=./configs/train-examplar/finetune_LIFF_LPIPS-full-1NN.yaml
NAME=examplar_finetune_full_LPIPS_1NN
INPUT_PATH_PREFIX=./data/samples/4X
RESULT_PATH_PREFIX=./data/samples/Results/test_examplar_finetune_full_LPIPS_1NN
