...
CONFIG=./configs/train-examplar/finetune_LIFF_LPIPS-encoder-internal.yaml
NAME=examplar_finetune_decoder_LPIPS_internal
INPUT_PATH_PREFIX=./data/samples/4X
RESULT_PATH_PREFIX=./data/samples/Results/test_examplar_finetune_decoder_LPIPS_internal
...
# IMG=0802
# python train_liif_examplar_2DLoss.py --config $CONFIG --name $NAME --tag $IMG.png --gpu $GPU_ID
# MODEL_PATH=./save/$NAME_$IMG.png/epoch-last.pth
# INPUT_PATH=$INPUT_PATH_PREFIX/$IMG.png
# RESULT_PATH=$RESULT_PATH_PREFIX/$IMG.png
