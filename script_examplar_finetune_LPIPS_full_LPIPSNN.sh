...
CONFIG=./configs/train-examplar/finetune_LIFF_LPIPS-full-LPIPSNN.yaml
NAME=examplar_finetune_full_LPIPSNN
INPUT_PATH_PREFIX=./data/samples/4X
RESULT_PATH_PREFIX=./data/samples/Results/test_examplar_finetune_full_LPIPSNN
